...
**A:** NerChat!只是提供一个在中国大陆可以互相聊天的平台，联邦可能会带来未知的问题，并且我们也无法提供与Matrix主站等稳定的网络连接。因此联邦不在我们考虑的范围之内。
...
**A:** NerChat!主要通过IPv6网络对外提供服务，这是新一代的互联网通信协议。我们非常建议大家使用IPv6网络使用NerChat!。IPv6的连接质量要显著优于IPv4，那是技术限制，恕我们无能为力。另外我们的IPv4有可能会因为维护而中断，IPv6的连接质量相当稳定，不会有很大问题。
